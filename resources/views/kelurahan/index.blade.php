...
<script>
  var actionUrl = '{{ url('kelurahan') }}';
  var apiUrl = '{{ url('api/kelurahan') }}';

  var columns = [
    {data: 'DT_RowIndex', class: 'text-center', orderable: true },
    {data: 'nama_kelurahan', class: 'text-center', orderable: true },
    {data: 'nama_kecamatan', class: 'text-center', orderable: true },
    {data: 'nama_kota', class: 'text-center', orderable: true },
