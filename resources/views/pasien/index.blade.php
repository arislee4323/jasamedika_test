              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" name="nama_pasien" :value="data.nama_pasien" class="form-control" placeholder="Input title" required="">
                  </div>
                  <div class="form-group">
                    <label>Alamat</label>
                    <input type="text" name="alamat" :value="data.alamat" class="form-control" placeholder="Input title" required="">
                  </div>
                  <div class="form-group">
                    <label>No Telepon</label>
                    <input type="text" name="no_telp" :value="data.no_telp" class="form-control" placeholder="Input title" required="">
                  </div>
                  <div class="form-group">
                    <label>RT</label>
                    <input type="text" name="rt" :value="data.rt" class="form-control" placeholder="Input title" required="">
                  </div>
                  <div class="form-group">
                    <label>RW</label>
                    <input type="text" name="rw" :value="data.rw" class="form-control" placeholder="Input title" required="">
                  </div>
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" name="tanggal_lahir" :value="data.tanggal_lahir" class="form-control" placeholder="Input title" required="">
                  </div>
                  <div class="form-group">
